...
class FilterCategoryWidget extends StatefulWidget {
  ...
  final int? initialExecutorId;
  final Function(DateTimeRange?, ServiceType?, TroubleType?, Type?, int?)?
  onFiltersApplied;
...
class _FilterCategoryWidgetState extends State<FilterCategoryWidget> {
  ...
  void initState() {
    ...
    selectedExecutorId = widget.initialExecutorId;
  }
  ...
  clear() {
    ...
    widget.onFiltersApplied?.call(null, null, null, null, null);
  }
    ...
    bottomSheetWidget(
      ...
      child: PerformerWidget(
        onSelectItem: (String value) {
          setState(() {
            selectedExecutorName = value;
          });
        },
        onSelectEmployee: (Employee employee) {
          setState(() {
            selectedExecutorId = employee.id;
            selectedExecutorName = employee.fullName;
          });
        },
        isSelected: true,
      ),
