...
class FilterOrganizationWidget extends StatefulWidget {
  ...
  const FilterOrganizationWidget({
    super.key,
  ...
  @override
  State<FilterOrganizationWidget> createState() =>
      _FilterOrganizationWidgetState();
}

class _FilterOrganizationWidgetState extends State<FilterOrganizationWidget> {
            ...
            child: Column(
              children: [
                          ...
                          child: selectBtnWidget(
                            ...
                            onClear: () {
                              setState(() {
                                selectedServiceType = null;
                                selectedTroubleType =
                                    null; // Сбрасываем связанные типы проблем
                              });
                            },
                            onTap: _showService,
                          ),
                ...
                MainButton(
                  ...
                  isLoading: false,
                  isDisable: false, // Убираем обязательность периода
                ),
              ],
            ),
          );
        ...
        child: _ServiceTypesSelectionWidget(
          ...
          onSelect: (serviceType) {
            setState(() {
              ...
              selectedTroubleType = null; // Сбрасываем выбранный тип проблемы
            });
          },
        ),
      );
      ...
      child: Column(
        children: [
          BottomSheetTitle(
            title: AppStrings.selectService,
            onClear: () =>
                onSelect(serviceTypes.first), // Можно добавить логику очистки
          ),
      ...
      child: Column(
        children: [
          BottomSheetTitle(
            title: AppStrings.selectCategoryType,
            onClear: () =>
                onSelect(priorityTypes.first), // Можно добавить логику очистки
          ),
          const SizedBox(height: 20),
          Flexible(
            child: ListView.builder(
